...
module.exports.onLoad = async() => {
    ...
    const pathImg = resolve(__dirname, 'cache/canvas', 'marriedv5.png');
    if (!existsSync(dirMaterial)) mkdirSync(dirMaterial, { recursive: true });
    if (!existsSync(pathImg)) await downloadFile("https://i.ibb.co/mhxtgwm/49be174dafdc259030f70b1c57fa1c13.jpg", pathImg);
}
...
async function makeImage({ one, two }) {
    ...
    const batgiam_img = await jimp.read(__root + "/marriedv5.png");
    ...
    batgiam_img.composite(circleOne.resize(130, 130), 300, 150)
