...
module.exports.run = async function({ api, event, args }) {  
  ...
  var text = args.join(" ");  
  if (!text) return api.sendMessage("ادخل نص التعليق على اللوحة", threadID, messageID);  
  
  let imageBuffer = (await axios.get(`https://i.imgur.com/GXPQYtT.png`, { responseType: 'arraybuffer' })).data;  
